...
function GoogleButtonInner() {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="w-full flex items-center justify-center gap-3 border border-neutral-200 rounded-md px-4 py-2.5 text-sm font-medium hover:bg-neutral-50 transition-colors disabled:opacity-60"
    >
      {pending ? (
